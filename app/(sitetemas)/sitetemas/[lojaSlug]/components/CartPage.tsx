...
// O componente não precisa mais de props de initialCartItems e lojaNome
const formatCurrency = (value: number) =>
    new Intl.NumberFormat('pt-BR', { style: 'currency', currency: 'BRL' }).format(value);

const CartPage: React.FC = () => {
    // CORRIGIDO: Obtém o nome da loja e outras informações do contexto
    ...
    const [cartItems, setCartItems] = useState<CartItem[]>([
      ...
      { id: '2', produtoId: 'prod-2', nome: 'Calça Jeans Skinny', preco: 129.90, quantidade: 2, imagem_url: 'https://placehold.co/100x100?text=Calça', variacoesSelecionadas: { cor: 'Azul', tamanho: 'M' } },
    ]);
        ...
        <div className="ph-cart-page">
            ...
            {cartItems.length === 0 ? (
                <div className="ph-empty-cart-message">
                    ...
                    <Link href={`/${lojaData?.slug || ''}`} className="ph-continue-shopping-button">
                        Continuar Comprando
                    </Link>
                </div>
            ) : (
