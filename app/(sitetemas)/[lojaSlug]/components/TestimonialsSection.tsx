// app/(sitetemas)/[lojaSlug]/components/TestimonialsSection.tsx
'use client';
...
// REMOVIDO: import '../styles/testimonials-section.css'; // O estilo virá do tema ativo
...
interface TestimonialData {
    ...
    // Adicione outros campos, como imagem do cliente
    imagemClienteUrl?: string | null;
}

interface TestimonialsSectionProps {
    testimonials: TestimonialData[];
    // Você pode adicionar um título dinâmico para a seção
    sectionTitle?: string;
}
                    ...
                    <div key={testimonial.id} className="ph-testimonial-card">
                        {testimonial.imagemClienteUrl ? (
                            ...
                            <div className="ph-testimonial-avatar-placeholder">
                                <User size={40} /> {/* Ícone genérico de usuário */}
                            </div>
                        )}
